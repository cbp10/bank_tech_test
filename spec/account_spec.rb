...
describe Account do
  ...
  context "deposit" do
    ...
    it 'should raise error if deposit is made with amount with more that 2dp' do
      expect { account.deposit(100.1234) }.to raise_error "Cannot make deposit: Value not recognised"
    end
  end
  ...
  context "withdrawal" do
    ...
    it 'should raise error if withdrawal is made with amount with more that 2dp' do
      expect { account.withdrawal(100.1234) }.to raise_error "Cannot make withdrawal: Value not recognised"
    end
  end
